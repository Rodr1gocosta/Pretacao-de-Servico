package br.com.rodrigoproject.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("br.com.rodrigoproject.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("br.com.rodrigoproject.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
